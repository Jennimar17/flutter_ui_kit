        ...
        body: MaterialApp(
          ...
          theme: theme.copyWith(
            ...
            iconTheme: IconThemeData(
              color: Colors.blue
            ), colorScheme: theme.colorScheme.copyWith(secondary: Colors.green[300]).copyWith(background: Colors.blue[300]),
          ),
          darkTheme: theme.copyWith(
            ...
            iconTheme: IconThemeData(
                color: Colors.red
            ), colorScheme: theme.colorScheme.copyWith(secondary: Colors.yellow[700]).copyWith(background: Colors.blue[700])
          ),
